...
<section class="content">
      <div class="container-fluid">
      <form role="form" method="post" action="insertquestionrequirements">
                <div class="card-body">
                  <div class="form-group">
                   ...
                   <label >Option A</label>
                    <input type="text" name="optionA" class="form-control"  placeholder="Enter option a">
                     <br>
                     <label >Option B</label>
                 <input type="text" name="optionB"  class="form-control"  placeholder="Enter option b">
                 ...
                 <input type="text" name="correct_option"  class="form-control"  placeholder="Enter correct option">
