...
<!-- materials start -->
<div class="container" style="margin-right: 20px; margin-top: 50px;">
  <div class="row">
  <?php foreach($data as $d): ?>
    <div class="col-md-4 nsf" >
      <div class="card" style="width: 18rem;background-color: #EDEFFF;" style="border-radius: 40px;">
        <img  style="width: 150px; height: 150px; margin-left: 80px;margin-top: 20px; margin-bottom: 30px;" src="<?= CSS_PATH;?>front/images/test.png" class="card-img-top" alt="...">
        <p class="card-text"style="text-align: center; color: #000;"><?= $d['name'];?></p>
        <div class="card-body"style="text-align: center;background-color: #2E2E2E; color: white;">
          <a href="<?= CSS_PATH;?>material/showlevel" style="text-decoration: none;color: white;text-align: center;" class="card-text">Take a test</a>
