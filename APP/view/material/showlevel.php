...
<section class="content">
      <div class="container-fluid">
              ...
              <h3>Choose easy exam</h3>

              <input type="radio" name="chooseeasy" value="Easy">       Easy<br><br>
              <h3>Choose  average exam</h3>
              <input type="radio" name="chooseaverage"value="Average" >    Average<br><br>
              <h3>Choose  difficult exam</h3>
             <input type="radio"  name="choosediff" value="Difficult" > Difficult<br><br>
             <br>
