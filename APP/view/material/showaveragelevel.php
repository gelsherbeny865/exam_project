...
<section class="content">
      <div class="container-fluid">
                  ...
                  <h1> Determine the level of the exam</h1>
 
              <form action="cn" method="post">
              
              <input type="radio" name="choose" value="Easy">       Easy<br><br>
             
              <input type="radio" name="choose"value="Average" >    Average<br><br>
              
             <input type="radio"  name="choose" value="Difficult">  Difficult<br><br>
             <br>
