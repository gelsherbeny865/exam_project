...
<body>
   ...
   <div class="container">
<img src="<?= CSS_PATH; ?>front/images/login.PNG" alt="" style="width: 100%; height: 690px;">
   </div>
...
<div class="container" >
  ...
  <form action="/admin/updatestudent" method="post" class="top-left" style="margin-top: 260px; margin-left: 200px;">

    <div class="form-group">
        <div class="col-md-6" style="width: 500px;">
            <label for="validationCustom01" class="form-label">Name</label>
            <input type="text" name="name" value="<?= $data->name?>"class="form-control" id="validationCustom01" placeholder="Enter your name" required>
    ...
    <div class="form-group">
      ...
      <input type="password" name="password"  value="<?=$data->password?>"class="form-control" id="exampleInputPassword1" placeholder=" Enter Password">
    </div>
    <br>
 &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
 <input type="hidden" name="id_student" value="<?= $data->id?>">
    <button type="submit" class="btn btn-primary logbtn" style="background-color:#DEE2FF !important; color: #000 !important; border-style: none; width: 100px; height: 40px;border-radius:19px;">Sign Up</button>
       ...
       <div class="container-fluid mt-5 mb-4 text-center text-md-left" style="background-color: #F2F3FF;">
        <div class="row mt-3">
          ...
          <div class="col-md-3 col-lg-4 col-xl-3 mb-4 dark-grey-text"><br>
            <a style="font-size: xx-large ; font-weight: bold; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Oxygen, Ubuntu, Cantarell, 'Open Sans', 'Helvetica Neue', sans-serif;" class="navbar-brand" href="<?= CSS_PATH;?>home/index"><span style="color: #A8B1FF; font-size: xx-large;">&nbsp; &nbsp; &nbsp; SE</span> <span style="color: #000000;">-exams</span></a>
