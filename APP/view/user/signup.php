...
<div class="container" >
  ...
  <form action="insertdata" method="post" class="top-left" style="margin-top: 260px; margin-left: 200px;">
    ...
    <div class="row g-2">
        <div class="col-md">
            <div class="form-floating">
              ...
              <label for="floatingSelectGrid">choose your grade</label>
            </div>
          </div>
        <div class="col-md">
          <div class="form-floating">
            ...
            <label for="floatingSelectGrid">choose your department</label>
          </div>
        </div>
      </div>
<br> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
