...
<body>
   ...
   <div class="container">
<img src="<?= CSS_PATH;?>front/images/login.PNG" alt="" style="width: 100%;">
   </div>
   


<div class="container" >
  <form   method="post"  action="SelectProfessorAllData" class="top-left" style="margin-top: 270px; margin-left: 200px;">
    ...
    <br> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
    <button type="submit" class="btn btn-primary logbtn" style="background-color:#DEE2FF !important; color: #000 !important; border-style: none; width: 100px; height: 40px;border-radius:19px;">Log In</button>
  </form>
</div>
