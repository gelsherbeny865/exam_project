...
<body>
        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse justify-content-center" id="navbarNavAltMarkup">
            <div class="navbar-nav">
              <a class="nav-link active headpad" aria-current="page" href="<?=CSS_PATH;?>home/learnmore" style="color: #A8B1FF !important; font-weight: 900 !important; ">Home</a>
            ...
            <div class="row align-items-center" >
                <div class="col-md-8"   >
                    ...
                    <p style="margin-top: 10px;">
                     <h1>What is  <span style="color: #A8B1FF;">e-exam</span> definition</h1>
                     <br>  <h5 style="font-weight: 600 ; color: gray; ">Online examination is conducting a test 

                 online to measure <br> the knowledge of the 
                 participants on a given topic. <br> In the olden 
                  days, everybody had to gather in a 
                 classroom <br> at the same time to take an exam.
                 </h5>
                      </p><br>
                     <br><br><br><br><br><br><br><br><br><br>
                  </div>
                <div class="col-md-4">
                    <img src="<?= CSS_PATH;?>front/images/aboutimg.PNG" style="height: 550px;" >
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="hero">
        <div class="container-fluid" >
            <div class="row align-items-center" >
                <div class="col-md-7">
                    <img src="<?= CSS_PATH;?>front/images/about2.PNG" style="height: 550px;" >
                </div>
                <div class="col-md-5"   >
                    <br><br><br>
                 
                    <p style="margin-top: 10px;">
                     <h1>How easily it is</h1>
                     <br>  <h5 style="font-weight: 600 ; color: gray; ">
                        With online examination students
                        can do the exam online, in their own time,
                        with their own device, regardless of where they live.
